...
public sealed class AnalysisTimeResolver
{
    ...
    public AnalysisTimeResult Resolve(
        ...
        IReadOnlyList<CanonicalRecord> analysisRecords)
    {
    ...
    private ResolvedEndpointTime? ResolveFirstRecordTime(IReadOnlyList<CanonicalRecord> analysisRecords)
    {
    ...
    private ResolvedEndpointTime? ResolveLastRecordTime(IReadOnlyList<CanonicalRecord> analysisRecords)
    {
